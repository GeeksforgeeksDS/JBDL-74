...
public class UserService {
     ...
     *
     */
    @Qualifier(value = "userInfoMysqlRepository")
    @Autowired
    ...
    public UserInfo fetchUserInfo(String id){
        ...
        Optional<UserInfo> userInfo = userInfoMySqlRepository.fetchUserInfoById(id);
        if(userInfo.isEmpty()){
    ...
    public UserInfo createUser(CreateUserRequest userRequest){
        ...
        return userInfoMySqlRepository.saveOrUpdate(userInfo);
    }
